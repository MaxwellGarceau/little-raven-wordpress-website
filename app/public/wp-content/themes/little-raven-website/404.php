...
<section class="main-background" style="padding-bottom: 450px">
    <video class="video-fullpage page-video hidden" poster="<?php echo wp_upload_dir()['baseurl'];?>/2018/04/vid-poster.png" autoplay="true" loop controls muted playsinline>
